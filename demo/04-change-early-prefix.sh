...
response="$script_dir/out/04-change-early-prefix.json"
...
payload=$(cat <<'JSON'
{
  ...
  "messages": [
    { "role": "system", "content": "You serve as a CFD simulation engineer for OpenFOAM v12 case setup. Keep every reply under three sentences. Quote dictionary keywords exactly as they appear in the v11 user guide, including defaults. Flag explicitly whenever a question refers to another OpenFOAM release. Admit ignorance rather than guessing." },
